...
public class BaseClass {
	...
	/**
	 * initilize the all activities open Excel,open property file read the common
	 * data creatae the instance for browser(launch browser) maximize,implicit wait
	 * open the application initilize jsexecutor,actions,webdriverwait create the
	 * instance foe commom object repo
	 * 
	 * @throws IOException
	 * 
	 */
//	SATISH
	 ...
	 * for testcase create the instance for browser(launch the browser) initilize
	 * jsexecutor,actions,webdriverwait create the instance for common object
	 * repo(driver) login to app
	 */
	/*
	 * @BeforeMethod(groups = "baseclass") public void methodSetUp() {
	 * 
	 * loginbutton.loginAction(username, password); }
	 */
